# Blog Post #1: Rolling into Unity - My First Steps
...
When I first opened Unity after downloading it, I felt a mix of excitement and intimidation. The interface looked complex, with panels everywhere and buttons I didn't understand. But after completing Unity's initial onboarding tutorial, I was ready to tackle Roll-a-Ball—and honestly? It was way more fun than I expected.

This wasn't just about following steps. It was about understanding *why* a ball rolls, *how* physics works in a game engine, and discovering that making games isn't magic—it's logic, creativity, and a whole lot of problem-solving.
...
But here's the cool part: the tutorial taught me to use `FixedUpdate()` instead of the regular `Update()` function for physics. Why? Because physics needs to run at a consistent rate, not tied to how fast the game is rendering frames. This might sound technical, but it clicked when I saw it in action—the ball moves smoothly regardless of whether my computer is struggling or cruising.
...
Just three lines to make a ball roll around! The `AddForce` part was genius—it doesn't teleport the ball or snap it to positions. It *pushes* the ball like you would in real life, and Unity's physics engine handles all the rolling, momentum, and realistic movement. I didn't have to program any of that complexity!

### When Things Disappear vs. When They Bounce

One of my favorite discoveries was learning about **triggers** versus **collisions**. At first, I thought they were the same thing—something touches something else, right? But Unity has two completely different systems:

**Triggers** let things pass through each other while detecting the contact. Perfect for collectibles! The ball rolls through the golden cubes, they vanish, and my score goes up. No bouncing, no physics reaction—just pure detection.
...
- A Rigidbody (makes it obey physics—gravity, momentum, forces)
- A Sphere Collider (defines its physical shape for collisions)
- My PlayerController script (the custom behavior I wrote)

It's like LEGO! You don't have one giant LEGO piece that's a whole spaceship. You snap together smaller pieces—wings, cockpit, engines—and suddenly you have a spaceship. Same with Unity. Snap together Transform + Rigidbody + Collider + Script, and suddenly you have a player character.
...
I added walls. Not just little barriers—massive elevated cube structures that blocked the camera's view and created these mysterious enclosed spaces. The psychology here was deliberate: if players can't see where all the collectibles are, they have to *explore*. They can't just count the remaining golden cubes and know when they're done.
...
I wanted to add danger, so I implemented a NavMesh enemy—a red cube that actively chases the player. Setting this up involved:
...
For about an hour, this didn't work. The enemy just sat there, unmoving, mocking me. I checked the NavMesh—fine. I checked the agent settings—fine. I stared at my code for what felt like forever.
...
Roll-a-Ball wasn't just a tutorial—it was a foundation. Every concept I learned here will show up in my main project, just in different forms:
...
The tutorial was easier than I expected, mostly because I'd already done Unity's initial onboarding. But that doesn't make it less valuable—it made things *click*. I moved from "following instructions" to "understanding why these instructions work." That's the difference between memorizing and learning.

The component system, the physics engine, the input handling, the collision detection—all of these are tools in my toolkit now. They're not mysterious black boxes anymore. They're systems I understand, can modify, and can combine in new ways.

What excites me most? **The moment when I stopped following the tutorial and started creating.** Building that obstacle course, adding the chasing enemy, watching friends playtest—that's when it became *my* game instead of just a tutorial I completed. That's the feeling I want for Arcane Trials: not just building what's required, but creating something that surprises me in the process.
...
**Unity, I'm ready for you. Let's make some magic.** ✨
...
*Strategic wall placement creates mysteries—you can't see everything from the start*
...
**What's Next:** Game Design Document for Arcane Trials, where this simple ball-rolling game evolves into a full wizard combat experience. Stay tuned! 🧙‍♂️

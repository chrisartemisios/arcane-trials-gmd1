# 🧙 Arcane Trials - GMD1 Course Project
...
### YouTube Demo
🎬 *[Demo video coming soon - to be uploaded before May 28th]*

### Blog Posts
📝 **Course Development Blog:**
...
### Playable Build
🌐 *[WebGL build on GitHub Pages - coming soon]*
...
├── Assets/
│   ├── Scripts/
│   │   ├── Core/           # Game managers, scene control
│   │   ├── Player/         # Player controller and abilities
│   │   ├── Enemies/        # Enemy AI and behaviors
│   │   ├── Challenges/     # Challenge-specific systems
...
│   ├── Prefabs/
│   └── Scenes/
├── BlogPosts/              # Development blog posts
└── README.md
```
